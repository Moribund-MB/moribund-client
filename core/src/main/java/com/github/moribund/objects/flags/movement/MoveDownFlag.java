...
/**
 * The {@link com.github.moribund.objects.flags.Flag} that signifies that a {@link RestrictedMovable} is moving downwards.
 */
public class MoveDownFlag implements Flag {
    @Override
